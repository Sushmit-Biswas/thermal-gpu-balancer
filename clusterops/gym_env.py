"""
Gymnasium wrapper for the ClusterOps environment server.

This wraps the HTTP-based ClusterOps server into a standard Gymnasium
interface so you can use it with RL libraries like Stable-Baselines3 or TRL.

Requires the ClusterOps server to be running.
"""
...
class ClusterOpsEnv(gym.Env):
    ...
    def __init__(self, difficulty="medium", scenario="01_baseline", max_nodes=20, max_queue=20):
        super().__init__()

        self.difficulty = difficulty
        self.scenario = scenario
        self.base_url = os.getenv("ENVIRONMENT_BASE_URL", "http://127.0.0.1:8000")
    ...
    def reset(self, seed=None, options=None):
        ...
        response = requests.post(
            ...
            json={"difficulty": self.difficulty, "scenario": self.scenario},
        )
    ...
    def render(self):
        # Not implementing a visual renderer
        pass
